...
class DeployTest extends TestCase
{
    ...
    private static function copyGcloudIgnore($targetDir)
    {
        copy(__DIR__ . '/../.gcloudignore', $targetDir . '/.gcloudignore');
    }
